...
def test_prosit_collisionenergies_determine_type():
    """Test PROSITcollisionenergies.determine_type."""
    # numeric
    ce = [10, 20, 30, 40, 50]
...
def test_prosit_collisionenergies_init():
    """Test init of PROSITcollisionenergies."""
    # numeric
...
def test_prosit_collisionenergies_prepare_collisionenergies():
    """Test PROSITcollisionenergies and prepare_collisionenergies."""
    inst = prpc.PROSITcollisionenergies(ce_numeric)
